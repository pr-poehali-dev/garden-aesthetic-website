    ...
    <div className="mt-12 p-8 bg-[#606C38] text-white rounded-md relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="mb-6 max-w-3xl">
          Садоводство — это не только забота о растениях, но и забота о себе.
          Каждый момент, проведенный с растениями, помогает снизить стресс,
          очистить мысли и найти радость в простых вещах.
        </p>
...
const ProcrastinationReason = ({
  title,
  content,
}: ProcrastinationReasonProps) => {
  return (
